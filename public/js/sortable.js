...
function ts_makeSortable(table) {
  ...
  if (!firstRow) return; // We have a first row: assume it's the header, and make its contents clickable links
...
function ts_resortTable(lnk, clid) {
  TIMERSTART = new Date().getTime(); // get the span
  ...
  var table = getParent(td, "TABLE"); // Work out a type for the column
