    ...
    prototype: {
        ...
        if (this.settings.focusInvalid) {
          try {
            $(
              ...
              .filter(":visible")
              .focus() // manually trigger focusin event; without it, focusin handler isn't called, findLastActive won't have anything to find
              .trigger("focusin");
          } catch (e) {
      ...
      defaultMessage: function (element, method) {
        return this.findDefined(
          ...
          this.customDataMessage(element, method), // title is never undefined, so handle empty string as undefined
